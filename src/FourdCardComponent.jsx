  ...
  return (
    <section className="section-main">
        ...
        <div className="cards-section">
          ...
          <article className="card-team animate__animated animate__backInLeft">
            <h3>Team Builder</h3>
            <p className="paragraph-card">Scans our talent network to create the optimal team for your project</p>
            <img src="/images/icon-team-builder.svg" alt="" />
          </article>
          <article className="card-karma animate__animated animate__backInLeft">
            <h3>Karma</h3>
            <p className="paragraph-card">Regularly evaluates our talent to ensure quality</p>
            <img src="/images/icon-karma.svg" alt="" />
          </article>
          <article className="card-calculator animate__animated animate__backInLeft">
            <h3>Calculator</h3>
